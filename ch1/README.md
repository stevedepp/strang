...
and theta for v-w is the angle between v and w
and theta for v+w is the angle between end of v and beginning of w leading to v+w



some matrix building 
...
- rows at a time --> dot product of m rows with one column vector 
  m equations meeting at one spot - linear program
- columns at a time or combination of the columns 
  --> column vector contains weights for linear combination of matric columns
- matrix multiplies unknown column vector weights to get b column vector
